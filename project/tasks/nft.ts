...
task("mint-nft", "Mint An NFT").addParam("tokenUri","Your ERC721 Token URI",undefined,types.string)
.setAction(async (tokenUri,hre)=>{
    return getContract("MyNFT",hre)
    .then((contract:Contract)=>{
        return contract.mintNFT(env("ETH_PUBLIC_KEY"),tokenUri,{ gasLimit:500_000,});
    })
}
)
...
// import { TransactionResponse } from "@ethersproject/abstract-provider";
// import { env } from "../lib""
// import { getContract } from "@openzeppelin/contracts";
// import { getWallet } from "../lib/wallet";
